...
//		}
	...
	Editor.createMinimalCss = function()
	{
		...
		return (Editor.isDarkMode() ?
			...
			'html body .geMenuItem { display: flex; width: auto; font-size:14px; text-decoration: none; font-weight: normal; padding: 6px 10px 6px 10px; border: none; border-radius: 5px; color: #353535; box-shadow: inset 0 0 0 1px rgba(0,0,0,.11), inset 0 -1px 0 0 rgba(0,0,0,.08), 0 1px 2px 0 rgba(0,0,0,.04); ' + (EditorUi.isElectronApp? 'app-region: no-drag; ' : '') + '}' +
	...
	{
		new LinkDialog(this, value, btnLabel, fn, true, showNewWindowOption, linkTarget);
	};
